...
const imageSrc = 'https://toppng.com/uploads/preview/circle-shapes-round-shape-flowchart-geometry-blank-circle-11562907613zjjlv24z2j.png';
  ...
  return (
    ...
    <div className="form-section">
        <h1>Advertisement Form</h1>
          ...
          <b1>Coin Name:</b1>
          <input type="text" name="coinName" value={formData.fucoinNamellName} placeholder="Your Answer" onChange={handleChange} required />
          <b1>Coin Symbol:</b1>
          <input type="text" name="coinSymbol" value={formData.coinSymbol} placeholder="Your Answer" onChange={handleChange} required />
          {/* <b1>Coin Icon:</b1>
          <Image className="mx-auto max-w-lg rounded-circle" style={{ maxWidth: '120px'}} src={imageSource} alt="Avatar" />
          <input
            type="file"
            accept="image/*"
          ...
          <b1>Website URL:</b1>
          <input type="url" name="websiteURL" value={formData.websiteURL} placeholder="Your Answer" onChange={handleChange} required />
          <b1>Social Medias:</b1>
          <textarea name="socialMedias" value={formData.socialMedias} placeholder="Your Answer" onChange={handleChange} required></textarea>
          <b1>Hashtags:</b1>
          <input type="url" name="hashtags" value={formData.hashtags} placeholder="Your Answer" onChange={handleChange} required />
          <b1>Marketing Dimensions:</b1>
          <textarea name="marketingDimensions" value={formData.marketingDimensions} placeholder="Your Answer" onChange={handleChange} required></textarea>
